...
import { postActionAPI } from "../actions";
        ...
        <>
            {
                ...
                <Container>
                    <Content>
                        ...
                        <ShareCreation>
                            <AttachAssets>
                                <AssetButton onClick={() => switAssetArea("image")}>
                                    <img src="/images/photo-icon.svg" alt="" />
                                </AssetButton>
                                <AssetButton onClick={() => switAssetArea("media")}>
...
const mapDispatchToProps = (dispatch) => ({
    postArticle : (payload) => dispatch(postActionAPI(payload))
});
